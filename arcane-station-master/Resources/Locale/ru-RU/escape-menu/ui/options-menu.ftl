...
ui-options-beer-effects-label = Эффекты Beer Station
ui-options-beer-shaders = Включить шейдеры Beer Station
ui-options-beer-fisheye = Эффект "рыбий глаз"
ui-options-beer-sprint-shake = Тряска экрана при спринте
ui-options-beer-warm-filter = Тёплый цветовой фильтр
ui-options-beer-bloom = Свечение источников света (bloom)
ui-options-beer-bullet-fx = Усиленные эффекты выстрелов
ui-options-beer-brightness = Увеличить яркость
ui-options-beer-vignette = Виньетка при падении
ui-options-beer-blood-splatter = Кровавые подтёки на экране
