...
gps-window-visibility-tooltip = Контролирует видимость ГПС на радарах.
gps-window-alarm-tooltip = Кнопка тревоги: подсвечивает ГПС приёмник на радарах. Используйте в экстренных ситуациях!
