ent-CrowbarAbductor = инопланетная монтировка
    .desc = Изготовлен из металла, более прочного, чем все, о чем могли мечтать в НаноТрейзен.
...
ent-ScrewdriverAbductor = инопланетная отвёртка
    .desc = Более эффективный, чем все, о чем мог мечтать НаноТрейзен. Не путать со звуковой отвёрткой.
