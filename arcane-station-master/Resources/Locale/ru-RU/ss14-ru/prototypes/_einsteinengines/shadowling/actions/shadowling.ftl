...
ent-ActionEnthrall = Подчинение
    .desc = Ломает волю, превращая существо в Трэлла. Не действует на тех, у кого есть щит разума, или на боргов.
...
ent-ActionCollectiveMind = Коллективный разум
    .desc = Поглощает разумы ваших Трэллов и даёт вам различные способности.
...
ent-ActionBlackRecuperation = Восстановление
    .desc = Возвращает мёртвого Трэлла к жизни или усиливает живого. Использование снижает вашу устойчивость к свету.
ent-ActionEmpoweredEnthrall = Порабощение
    .desc = Ломает волю, превращая в Трэлла. Быстрее и сильнее, действует даже на тех, кто защищён щитом разума.
...
ent-ActionAscendance = Вознесение
    .desc = Создайте кокон вознесения и ступите на путь божества. Ваши Трэллы должны будут долго защищать кокон. Обязательно подготовьтесь.
ent-ActionAnnihilate = Уничтожение
    .desc = Разрывает тела в клочья.
ent-ActionHypnosis = Гипноз
    .desc = Мгновенно превращает любого в Трэлла.
