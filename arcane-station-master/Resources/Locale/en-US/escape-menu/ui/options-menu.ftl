...
ui-options-beer-effects-label = Beer Station Effects
ui-options-beer-shaders = Enable Beer Station shaders
ui-options-beer-fisheye = Fisheye lens effect
ui-options-beer-sprint-shake = Sprint screen shake
ui-options-beer-warm-filter = Warm color filter
ui-options-beer-bloom = Light bloom
ui-options-beer-bullet-fx = Enhanced bullet effects
ui-options-beer-brightness = Boost brightness
ui-options-beer-vignette = Fall/crawl vignette
ui-options-beer-blood-splatter = Blood splatter on damage
