...
tips-dataset-14 = Remember to touch grass in between playing Beer Station 14 every once in a while.
...
tips-dataset-122 = Beer Station 14 is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
