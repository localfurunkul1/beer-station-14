...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleNano : StyleBase
    {
        ...
        public static readonly Color ButtonColorDefaultRed = Color.FromHex("#c89230");
        public static readonly Color ButtonColorHovered = Color.FromHex("#575b7f");
        public static readonly Color ButtonColorHoveredRed = Color.FromHex("#dcae4f");
        ...
        public StyleNano(IResourceCache resCache) : base(resCache)
        {
            ...
            {
                BackgroundColor = Color.FromHex("#c89230"),
                BorderColor = Color.FromHex("#6b4612"),
                BorderThickness = new Thickness(0, 0, 0, 2),
            };
            windowHeaderAlert.SetContentMarginOverride(StyleBox.Margin.Bottom, 0);
            ...
            Stylesheet = new Stylesheet(BaseRules.Concat(new[]
            {
                ...
                // Alert (beer) window title.
                new StyleRule(
                    new SelectorElement(typeof(Label), new[] {"windowTitleAlert"}, null, null),
                    new[]
                    {
                        new StyleProperty(Label.StylePropertyFontColor, Color.FromHex("#2b1a08")),
                        new StyleProperty(Label.StylePropertyFont, notoSansDisplayBold14),
                    }),
                // Window background.
                new StyleRule(
